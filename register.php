...
if(isset($_POST['userName'])){
	...
	$sql = "Insert Into company(userName,password,name,industry,empNum,location,contactPerson,phone,email,website,address,des) Values ('$userName','$password','$name','$industry','$empNum',$location,'$contactPerson','$phone','$email','$website','$address','$des')";
